...
public class AuthorService {
	...
	@Autowired
	private CustomAuthorRepo authorRepo2 ;
	...
	public void updateEmail(String email, String name , String phone) {
		authorRepo2.updateEmail(email, name, phone);
	}
	public void updateId(String id,String email, String name , String phone) {
		authorRepo2.updateId(id ,email, name, phone);
	}
